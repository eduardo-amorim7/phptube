...
if (!User::isLogged() && !empty($advancedCustomUser->userMustBeLoggedIn) && !empty($advancedCustomUser->userMustBeLoggedInCloseButtonURL)) {
    ...
    <?php } ?>
            ...
            <?php echo __("My Account"); ?>
					...
					<?php
						...
						<li>
								...
								<a href="<?php echo $global['webSiteRootURL']; ?>view/ecommerce/" class="btn btn-block" style="border-radius: 0;">
        ...
        <?php echo __("Trending"); ?>
			...
			<li>
			 	<div>
				<a href="<?php echo $global['webSiteRootURL'];?>view/ecommerce/" class="btn btn-warning btn-block" style="border-radius: 0;">
				<span class="glyphicon glyphicon-shopping-cart"></span>
...
<li>
	...
	<h3 class="text-danger"> <?php echo("Ecommerce");?>   </h3>

</li>

<li>
	<a href="<?php echo $global['webSiteRootURL']; ?>view/ecommerce/">

	<span class="glyphicon glyphicon-shopping-cart"></span>
	<?php echo __("Produtos"); ?>
	</a>
